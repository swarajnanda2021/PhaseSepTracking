function postproc_frenetframe
%postproc_frenetframe Process trajectory in its own frenet frame and transform
...
!not here gdir=[0 0 -1]'; % direction of gravitation
