function postproc_tangentframe
%postproc_tangentframe Process trajectory in frame w.r.t. velocity heading and
%   imposed z-gravity vector and copy all data in that frame.
...
gdir=[0 0 -1]'; % direction of gravitation
tdir=diff(y,t)/norm(diff(y,t),2);
ydir=cross(gdir,tdir)/norm(cross(gdir,tdir),2);
zdir=cross(ydir,tdir);
...
for l=unique(Index(1,:))
    ...
    if exist([folder date rec vsl 'Postproc3DTracking' vsl 'TrajectoryFrame' vsl 'Trajectory_' num2str(l) vsl 'TangentFrame'],'dir')~=7
        mkdir([folder date rec vsl 'Postproc3DTracking' vsl 'TrajectoryFrame' vsl 'Trajectory_' num2str(l) vsl 'TangentFrame'])
    end
    
    % Indexing
    fsave([folder date rec vsl ...
        'Postproc3DTracking' vsl 'TrajectoryFrame' vsl 'Trajectory_' num2str(l) vsl 'TangentFrame' vsl 'Index.dat']...
        ,tfrm_index,'w');
    
    % Quadric
    fsave([folder date rec vsl ...
        'Postproc3DTracking' vsl 'TrajectoryFrame' vsl 'Trajectory_' num2str(l) vsl 'TangentFrame' vsl 'Quadric.dat']...
        ,tfrm_quad,'w');
    
    % Position
    fsave([folder date rec vsl ...
        'Postproc3DTracking' vsl 'TrajectoryFrame' vsl 'Trajectory_' num2str(l) vsl 'TangentFrame' vsl 'Position.dat']...
        ,tfrm_pos,'w');
    
    % Velocity
    fsave([folder date rec vsl ...
        'Postproc3DTracking' vsl 'TrajectoryFrame' vsl 'Trajectory_' num2str(l) vsl 'TangentFrame' vsl 'Velocity.dat']...
        ,tfrm_vel,'w');
    
    % VelocityDifference
    fsave([folder date rec vsl ...
        'Postproc3DTracking' vsl 'TrajectoryFrame' vsl 'Trajectory_' num2str(l) vsl 'TangentFrame' vsl 'VelocityDifference.dat']...
        ,tfrm_delvel,'w');
    
    % Rotation Velocity
    fsave([folder date rec vsl ...
        'Postproc3DTracking' vsl 'TrajectoryFrame' vsl 'Trajectory_' num2str(l) vsl 'TangentFrame' vsl 'RotationVelocity.dat']...
        ,tfrm_rotvel,'w');
    
    % Relative Velocity
    fsave([folder date rec vsl ...
        'Postproc3DTracking' vsl 'TrajectoryFrame' vsl 'Trajectory_' num2str(l) vsl 'TangentFrame' vsl 'RelativeVelocity.dat']...
        ,tfrm_relvel,'w');
    
    % Accelaration
    fsave([folder date rec vsl ...
        'Postproc3DTracking' vsl 'TrajectoryFrame' vsl 'Trajectory_' num2str(l) vsl 'TangentFrame' vsl 'Accelaration.dat']...
        ,tfrm_acc,'w');
    
    % Accelaration
    fsave([folder date rec vsl ...
        'Postproc3DTracking' vsl 'TrajectoryFrame' vsl 'Trajectory_' num2str(l) vsl 'TangentFrame' vsl 'RotationAccelaration.dat']...
        ,tfrm_rotacc,'w');
    
    % Accelaration
    fsave([folder date rec vsl ...
        'Postproc3DTracking' vsl 'TrajectoryFrame' vsl 'Trajectory_' num2str(l) vsl 'TangentFrame' vsl 'MotionAccelaration.dat']...
        ,tfrm_motacc,'w');
    
    % Accelaration
    fsave([folder date rec vsl ...
        'Postproc3DTracking' vsl 'TrajectoryFrame' vsl 'Trajectory_' num2str(l) vsl 'TangentFrame' vsl 'AccelarationDifference.dat']...
        ,tfrm_delacc,'w');
    
    % Relative Accelaration
    fsave([folder date rec vsl ...
        'Postproc3DTracking' vsl 'TrajectoryFrame' vsl 'Trajectory_' num2str(l) vsl 'TangentFrame' vsl 'RelativeAccelaration.dat']...
        ,tfrm_relacc,'w');
    
    % message
    disp(['post processed tangent frame trajectory ',num2str(l)])
