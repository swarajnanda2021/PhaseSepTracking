...
% 1-D space
x_space = prop.range_x(1):prop.del_vox:prop.range_x(2);
y_space = prop.range_y(1):prop.del_vox:prop.range_y(2);
...
for tstep=ctrl.tproc(1):ctrl.tproc(2)
    ...
    for frame=1%ctrl.lfoc
        ...
        if 1 % Using the CNN model
            ...
            Img_stack_ref = imread([folder vsl date vsl rec '\Preproc3DReco\ImgSeg\Training\trainingImages\image_1.tiff']);
            ...
            Im1 = Segmented_img2.*Segmented_img2;
